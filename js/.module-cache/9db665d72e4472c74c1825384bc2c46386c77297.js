...
var Student = React.createClass({displayName: "Student",
  render: function() {
    return (
      ...
      React.createElement("h2", null, React.createElement("button", {className: "btn btn-info back", onclick: "goBack"}, React.createElement("span", {className: "glyphicon glyphicon-arrow-left", "aria-hidden": "true"}), " Back"), " Thông tin thành viên"), 
      React.createElement("table", null, 
        React.createElement("tbody", null, 
          React.createElement("tr", null, 
